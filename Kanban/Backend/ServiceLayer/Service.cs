...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class Service : IService
    {
        ...
        {
            Response response = us.DeleteData();
            if (response.ErrorOccured)
            {
                return response;
            }
        ...
        {
            Response response = us.Register(email, password, nickname);
            if (response.ErrorOccured)
            {
                return response;
            }
        ...
        {
            Response response = us.Register(email, password, nickname, emailhost);
            if (response.ErrorOccured)
            {
                return response;
            }
            return bs.AddUserToBoard(email, password, nickname, emailhost);
        }
        ...
        {
            return bs.AssignTask(email, columnOrdinal, taskId, emailAssignee, us.isactive(email));
        }
        ...
        {
            return bs.DeleteTask(email,columnOrdinal,taskId,us.isactive(email));
        }
        ...
        {
            return bs.GetBoard(email, us.isactive(email));
        }
        ...
        {
            return bs.ChangeColumnName(email,columnOrdinal,newName,us.isactive(email));
        }
        ...
        {
            return bs.LimitColumnTasks(email, columnOrdinal, limit, us.isactive(email));
        }
        ...
        {
            return bs.AddTask(email, title, description, dueDate, us.isactive(email));
        }
        ...
        {
            return bs.UpdateTaskDueDate(email, columnOrdinal, taskId, dueDate, us.isactive(email));
        }
        ...
        {
            return bs.UpdateTaskTitle(email, columnOrdinal, taskId, title, us.isactive(email));
        }
        ...
        {
            return bs.UpdateTaskDescription(email, columnOrdinal, taskId, description, us.isactive(email));
        }
        ...
        {
            return bs.AdvanceTask(email, columnOrdinal, taskId, us.isactive(email));
        }
        ...
        {
            return bs.GetColumn(email, columnName, us.isactive(email));
        }
        ...
        {
            return bs.GetColumn(email, columnOrdinal, us.isactive(email));
        }
        ...
        {
            return bs.RemoveColumn(email, columnOrdinal, us.isactive(email));
        }
        ...
        {
            return bs.AddColumn(email, columnOrdinal, Name, us.isactive(email));
        }
        ...
        {
            return bs.MoveColumnRight(email, columnOrdinal, us.isactive(email));
        }
        ...
        {
            return bs.MoveColumnLeft(email, columnOrdinal, us.isactive(email));
        }
    }
}
