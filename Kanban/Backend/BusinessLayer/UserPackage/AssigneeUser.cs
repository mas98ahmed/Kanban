...
namespace IntroSE.Kanban.Backend.BusinessLayer.UserPackage
{
    class AssigneeUser : IUser
    {
        ...
        public AssigneeUser(int id, string email, string password, string nickname, int boardid)
        {
        ...
        {
            return new Data.User(id, email, nickname, password, false, boardid);
        }
